            ...
            for application in applications:
                try:
                    applicants.append(Applicant(application['id'],
                                                ...
                                                application['gender'],
                                                application[
                                                    'acceptanceFormData'] if 'acceptanceFormData' in application else None,
                                                application['status']
                                                ))
                except KeyError as err:
                    return IncorrectParameterException(1, "The field" + str(
                        err) + "does not exists in the database document")
