...
def verify_email(email):
    white_list = ["kastner@unternehmertum.de", "marcus.paeschke@unternehmertum.de", "bela.sinoimeri@unternehmertum.de", "bela.sinoimeri@dpschool.io", "rieder@unternehmertum.de", "magda.nowak-trzos@unternehmertum.de","bedo@unternehmertum.de", "asaei@unternehmertum.de", "tobias.kalkowsky@unternehmertum.de"]
